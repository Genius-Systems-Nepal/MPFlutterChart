...
class YAxisRenderer extends AxisRenderer {
  ...
  List<double?> mGetTransformedPositionsBuffer = List.filled(2, null, growable: false);
  ...
  List<double?> getTransformedPositions() {
    if (mGetTransformedPositionsBuffer.length != _yAxis!.entryCount * 2) {
      mGetTransformedPositionsBuffer = List.filled(_yAxis!.entryCount * 2, null, growable: false);
    }
  ...
  List<double?> _renderLimitLinesBuffer = List.filled(2, null, growable: false);
