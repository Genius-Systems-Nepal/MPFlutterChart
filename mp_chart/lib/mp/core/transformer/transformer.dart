...
class Transformer {
  ...
  List<double?> _valuePointsForGenerateTransformedValuesScatter = List.filled(1, null, growable: false);
  ...
  List<double?> generateTransformedValuesScatter(
    ...
    if (_valuePointsForGenerateTransformedValuesScatter.length != count) {
      _valuePointsForGenerateTransformedValuesScatter = List.filled(count, null, growable: false);
    }
  ...
  List<double?> _valuePointsForGenerateTransformedValuesBubble = List.filled(1, null, growable: false);
  ...
  List<double?> generateTransformedValuesBubble(
    ...
    if (_valuePointsForGenerateTransformedValuesBubble.length != count) {
      _valuePointsForGenerateTransformedValuesBubble = List.filled(count, null, growable: false);
    }
  ...
  List<double?> _valuePointsForGenerateTransformedValuesLine = List.filled(1, null, growable: false);
  ...
  List<double?> generateTransformedValuesLine(
    ...
    if (_valuePointsForGenerateTransformedValuesLine.length != count) {
      _valuePointsForGenerateTransformedValuesLine = List.filled(count, null, growable: false);
    }
  ...
  List<double?> _valuePointsForGenerateTransformedValuesCandle = List.filled(1, null, growable: false);
  ...
  List<double?> generateTransformedValuesCandle(
    ...
    if (_valuePointsForGenerateTransformedValuesCandle.length != count) {
      _valuePointsForGenerateTransformedValuesCandle = List.filled(count, null, growable: false);
    }
  ...
  List<double?> _ptsBuffer = List.filled(2, null, growable: false);
