...
class Legend extends ComponentBase {
  ...
  List<FSize?> _calculatedLabelSizes = List.filled(16, null, growable: false);
  List<bool?> _calculatedLabelBreakPoints = List.filled(16, null, growable: false);
  List<FSize?> _calculatedLineSizes = List.filled(16, null, growable: false);
